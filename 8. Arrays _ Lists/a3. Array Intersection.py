...
#         first array/list.
#        Second line contains 'N' single space separated integers representing the elements of the
...
# Sample Input 1 :    2                               Sample Output 1 :   2 4 3
#                     6                                                   10
#                     2 6 8 5 4 3
#                     4
#                     2 3 4 7
...
# Sample Input 2 :    1                               Sample Output 2 :   2 1 2
#                     4
#                     2 6 1 2
#                     5
#                     1 2 3 4 2
...
def intersections(arr1, n, arr2, m) :                       # Soln. 1
    for i in range(n):
        for j in range(m):
            if arr1[i] == arr2[j]:
                print(arr1[i], end=" ")
...
# def intersections(arr1, n, arr2, m) :                       # Soln. 2 same as above
#     # arr3 = [value for value in arr1 if value in arr2]     # Soln. 3
#     arr3 = []
#     for i in range(n):
#         for j in range(m):
#             # if i >= j:
...
#                 arr3.append(arr1[i])
#                 arr3.sort()
#                 arr2[j] = sys.maxsize       # equivalent to  arr2[j] = -1
#                 break
#     print(' '.join(map(str, arr3)), end=" ")
...
#main
print("Enter the no. of Test Cases & Queries to be run: ")
