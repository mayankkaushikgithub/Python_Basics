...
Constraints:    1 <= |str| <= 10^5              Time Limit: 1 second

Sample Input 1:     Abhishek harshit Ayush harshit Ayush Iti Deepak Ayush Iti
Sample Output 1:    harshit 2
                    Ayush 3
                    Iti 2

Sample Input 2:     Abhishek Harshit Ayush Iti
Sample Output:      -1
'''
...
def differentNames(l):
    ...
    delete = []
    for key, val in mydict.items():     # deleting Keys with Value = 1
        if val == 1:
            delete.append(key)
    for i in delete:
        del mydict[i]
